...
Find the Mathematica code [here](Resources/LorenzAttractor.nb)
...
Using the function $$z_{n+1} = 1 - |2z_n - 1|^{1/2}$$ to model the data from Lorenz's map. Find the Mathematica code [here](Resources/ModelLorenzMap.nb).
